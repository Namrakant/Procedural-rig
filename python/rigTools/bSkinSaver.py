...
=====================================================================
    ...
    Note: Updated a bit so that it works with pyside2. This code does not belong to me at all. You can find the original file at https://www.highend3d.com/maya/script/bskinsaver-for-maya
...
from PySide2.QtWidgets import QApplication, QDialog, QLineEdit, QPushButton, QTabWidget
import shiboken2
import os
import time
...
class bSkinSaverUI(QtWidgets.QDialog):#(QtGui.QDialog):
